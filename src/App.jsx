...
function Quotes() {
  ...
  const mapeo = quotesRandon.map((quot) => {
    ...
    <div id="wrapper">
      <div id="quote-box">
        <div id="quote-text" style={{ opacity: 1 }}>
          <i className="fa fa-quote-left">::before</i>
          <span id="text">lalalalala</span>
        </div>
        <div className="quote-author" style={{ opacity: 1 }}>
          <span id="author">Jonh lennon</span>
        </div>
        <div id="buttons">
          <a
            className="button"
          ...
          >
            <i className="fa fa-tumblr">::before</i>
          </a>
          <button
